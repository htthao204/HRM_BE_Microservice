...
export const getAttendanceByIdController = async (
  ...
  try {
    ...
    res.status(200).json(ResultResponse(true, 200, null, null, attendance));
  } catch (err: any) {
    next(err);
  }
};
...
export const createAttendanceController = async (
  ...
  try {
    ...
    res.status(201).json(ResultResponse(true, 201, null, null, newAttendance));
  } catch (err: any) {
    next(err);
  }
};
...
export const deleteAttendanceController = async (
  ...
  try {
    ...
    res
      .status(200)
      .json(ResultResponse(true, 200, "Xóa thành công", null, null));
  } catch (err: any) {
    next(err);
  }
};
